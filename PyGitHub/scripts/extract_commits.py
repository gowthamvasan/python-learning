...
access_token = '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e'
...
def extract_project_commits(project_full_name):
    ...
    while True:
        try:
            ...
            continue
        break
    df_commits.to_csv('commits_milvik.csv', sep=',', encoding='utf-8', index=True)

# extract_project_commits('PyGithub/PyGithub')
extract_project_commits('milvik/infra-automation')
